...
function countingCharacters($strings)
{
    ...
    echo "<li>Las oraciones tienen " . $whiteSpacesAmount . " espacios</strong><br><br>";
}
...
function replace($strings)
{
    ...
    foreach ($strings as $ValueReplaced)
    {
        ...
        $max_char = 100;
        echo "<ul><li>" . @substr($strings[$wordToReplace], 0, $max_char) . "</ul></li>";
...
function wordCounting($strings)
{
    ...
    {
        $sentenceLine++;
        echo "Oración $sentenceLine tiene " . substr_count($Value, "Entrenamiento") . " " . " Entrenamiento<br/>";
        $texto += substr_count($Value, "Entrenamiento");
    }
    echo "El total de Entrenamiento son: " . $texto . " " . "<br />";
    return $word;
}
